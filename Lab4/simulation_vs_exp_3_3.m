...
exp_data = load('Lab4/Lab 4 360 Data/ff_lag_dbl_lead_notch.mat');
...
model = sim('double_lead_notch_lag_feedforward', 'SimulationMode', 'normal');
...
plot(x1_sim.time, x1_sim.signals.values, 'Color', 'b')
